...
/**
 * This class represents the transition conditions from the fall to the idle state.
 * @author Jonathan Kaplan <jonathankap@gmail.com>
 */
public class FallToIdle extends TransitionObject
{
    @Override
    protected boolean testCondition(GameState state) 
    {
        ...
        if (controller != null && controller.getHeight() <= 1.5f &&
            ...
            state.getContext().getActions()[ActionNames.Movement_Z.ordinal()] == 0)
        {    
