...
public class AvatarObjectCollection extends ObjectCollectionBase
{
    ...
    protected FastTable<SpatialObject> objects = new FastTable<SpatialObject>();
...
//            return null;
    ...
    @Override
    public FastTable<LocationNode> findPath(LocationNode source, String destination)
    {
        return null;
//        LocationNode destNode = locationNames.get(destination);
//        if (source.equals(destNode))
//            return null;
//        FastTable<LocationNode> path = new FastTable<LocationNode>();
...
//    }
    ...
    public void createTestPath()
    {
        ...
        FastTable<Vector3f> origin = new FastTable<Vector3f>();
        FastTable<Vector3f> point = new FastTable<Vector3f>();
...
//        ls.attach(dr);
    ...
    public FastTable<SpatialObject> getObjects() {
        return objects;
    }
