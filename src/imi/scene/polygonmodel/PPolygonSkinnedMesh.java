...
/**
 * Mesh geometry with skinning data
...
//        }
    ...
    {
        m_influenceIndices = new int[indices.length];
        for (int i = 0; i < m_influenceIndices.length; ++i)
            m_influenceIndices[i] = indices[i];
    }
    ...
    /**
     * Retrieves a reference to the backing FastTable
     * @return m_boneWeights (FastTable<Vector3f>)
     */
    ...
    /**
     * Retrieves a reference to the backing FastTable
     * @return m_boneIndices (FastTable(PBoneIndices>)
     */
