...
public class ShaderUtils 
{
    ...
    public static final String  ShaderProgramPackage = "imi.scene.shader.programs";
     ...
     */
    public static void assignProperties(Collection<ShaderProperty> props,
                                        GLSLShaderObjectsState shaderState)
    {
        ...
        {
            // big nasty switch statement... not as hard to maintain as it looks.
            switch(prop.type)
            {
                case GLSL_VOID:
                    ...
                    // nonsense uniform
                    System.out.println("ShaderUtils.java:assignProperties: Uniform of type \"void\" cannot be set.");
                    break;
                case GLSL_BOOL:
     ...
     */
    private static ArrayList<GLSLShaderEffect> GloballyAvailableEffects = new ArrayList<GLSLShaderEffect>();
