...
public class GLSLShaderEffect implements Serializable
{
     ...
     */
    protected ArrayList<GLSLShaderVariable>  m_FragmentInitializations   = null;
    protected ArrayList<GLSLShaderVariable>  m_VertexInitializations     = null;
     ...
     * executes.
     */
    protected ArrayList<GLSLShaderVariable>  m_FragmentModifications   = null;
    protected ArrayList<GLSLShaderVariable>  m_VertexModifications     = null;
     ...
     * behave as designed.
     */
    protected ArrayList<GLSLShaderVariable>  m_FragmentDependencies   = null;
    protected ArrayList<GLSLShaderVariable>  m_VertexDependencies     = null;
     ...
     */
    public final GLSLShaderVariable[] getVertexGlobals()
    {
     ...
     */
    public final void setVertexGlobals(GLSLShaderVariable[] vertexGlobals)
    {
     ...
     */
    public final GLSLShaderVariable[] getFragmentGlobals()
    {
     ...
     */
    public final void setFragmentGlobals(GLSLShaderVariable[] fragmentGlobals)
    {
     ...
     */
    public final GLSLVertexAttribute[] getVertexAttributes()
    {
     ...
     */
    public final void setVertexAttributes(GLSLVertexAttribute[] vertAttributes)
    {
     ...
     */
    public final GLSLShaderUniform[] getVertexUniforms()
    {
     ...
     */
    public final void setVertexUniforms(GLSLShaderUniform[] vertUniforms)
    {
     ...
     */
    public final GLSLShaderUniform[] getFragmentUniforms()
    {
     ...
     */
    public final void setFragmentUniforms(GLSLShaderUniform[] fragUniforms)
    {
     ...
     */
    public GLSLShaderVarying[] getVariants()
    {
        return m_varying;
    }
     ...
     */
    public void setVariants(GLSLShaderVarying[] variants)
    {
        m_varying = variants;
    }
     ...
     */
    public ArrayList<GLSLShaderVariable> getFragmentInitializations()
    {
     ...
     */
    public void setFragmentInitializations(ArrayList<GLSLShaderVariable> fragInit)
    {
     ...
     */
    public ArrayList<GLSLShaderVariable> getFragmentDependencies()
    {
     ...
     */
    public void setFragmentDependencies(ArrayList<GLSLShaderVariable> FragmentDependencies)
    {
     ...
     */
    public ArrayList<GLSLShaderVariable> getFragmentModifications()
    {
     ...
     */
    public void setFragmentModifications(ArrayList<GLSLShaderVariable> FragmentModifications)
    {
     ...
     */
    public ArrayList<GLSLShaderVariable> getVertexDependencies()
    {
     ...
     */
    public void setVertexDependencies(ArrayList<GLSLShaderVariable> VertexDependencies)
    {
     ...
     */
    public ArrayList<GLSLShaderVariable> getVertexInitializations()
    {
     ...
     */
    public void setVertexInitializations(ArrayList<GLSLShaderVariable> VertexInitializations)
    {
     ...
     */
    public ArrayList<GLSLShaderVariable> getVertexModifications()
    {
     ...
     */
    public void setVertexModifications(ArrayList<GLSLShaderVariable> VertexModifications)
    {
