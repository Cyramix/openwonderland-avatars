 ...
 */
public class ClothingShaderSpecColor extends BaseShaderProgram implements AbstractShaderProgram, Serializable
{
...
//        "       gl_FragColor = vec4(normalize(ToLight), 1);" + // Instrumentation
     ...
     * @param wm
     */
    public ClothingShaderSpecColor(WorldManager wm)
    {
        this(wm, 0.2f);
    }

    protected ClothingShaderSpecColor(ClothingShaderSpecColor other)
    {
        super(other);
    }
     ...
     */
    public ClothingShaderSpecColor(WorldManager wm, float fAmbientPower)
    {
...
//
    ...
    {
        ClothingShaderSpecColor result = new ClothingShaderSpecColor(this);
        return result;
    }
