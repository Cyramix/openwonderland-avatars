...
import imi.shader.dynamic.GLSLDefaultVariables.Locality;
 ...
 */
public class GLSLShaderProgram extends AbstractShaderProgram implements RenderUpdater, Serializable
{
     ...
     * string.
     */
    protected final static String preamble = 
            "/****************************************" + NL +
     ...
     */
    private final FastTable<GLSLShaderEffect> m_effects = new FastTable<GLSLShaderEffect>();
     ...
     */
    protected GLSLShaderProgram(WorldManager wm, boolean useDefaultInitializers)
    {
        setWorldManager(wm);
            ...
            if (effect.getVertexUniforms() != null)
            {
                for (GLSLShaderUniform uniform : effect.getVertexUniforms())
                {
                    ...
                    if (uniform != GLSLDefaultVariables.Pose)
                        ...
                        uniforms.add("uniform mat4 pose[55];" + NL);
                }
            }
    ...
    /**
     * Retrieve a reference to the backing FastTable
     * @return the collection
     */
    public FastTable<GLSLShaderEffect> getEffects()
    {
        return m_effects;
    }
     ...
     */
    @Override
    public synchronized boolean applyToRenderStates(PPolygonMeshInstance meshInst)
    {
        m_bShaderLoaded = false;
        m_WM.addRenderUpdater(this, meshInst);
        return true;
    }
    ...
    public void update(Object obj)
    {
        ...
        shaderState.load(getVertexProgramSource(), getFragmentProgramSource());
     ...
     * @return True on success, false otherwise
     * @throws imi.shader.NoSuchPropertyException Thrown if the specified
