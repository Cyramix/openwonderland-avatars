 ...
 */
public class NewSkinningMethodTest extends DemoBase
{
    
    public NewSkinningMethodTest(String[] args) 
    {
        super(args);
    }
    ...
    public static void main(String[] args) {
        NewSkinningMethodTest worldTest = new NewSkinningMethodTest(args);
    }
